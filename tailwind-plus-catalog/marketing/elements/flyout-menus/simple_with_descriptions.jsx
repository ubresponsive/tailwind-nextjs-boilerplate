...
export default function ElementsFlyoutMenusSimpleWithDescriptions() {
  return (
    <Popover className="relative">
      ...
      >
        <div className="w-screen max-w-sm flex-auto rounded-3xl bg-white p-4 text-sm/6 shadow-lg outline-1 outline-gray-900/5">
          {solutions.map((item) => (
