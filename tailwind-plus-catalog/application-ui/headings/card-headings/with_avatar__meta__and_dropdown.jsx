...
export default function HeadingsCardHeadingsWithAvatarMetaAndDropdown() {
  return (
      ...
      <div className="flex space-x-3">
        ...
        <div className="flex shrink-0 self-center">
          <Menu as="div" className="relative inline-block text-left">
            <MenuButton className="relative flex items-center rounded-full text-gray-400 outline-offset-6 hover:text-gray-600">
