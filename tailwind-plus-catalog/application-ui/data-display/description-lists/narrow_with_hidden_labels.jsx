...
export default function DataDisplayDescriptionListsNarrowWithHiddenLabels() {
  return (
      ...
      <div className="rounded-lg bg-gray-50 shadow-xs outline-1 outline-gray-900/5">
        <dl className="flex flex-wrap">
          ...
          <div className="flex-none self-end px-6 pt-4">
            ...
            <dd className="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 inset-ring inset-ring-green-600/20">
              Paid
            </dd>
          </div>
