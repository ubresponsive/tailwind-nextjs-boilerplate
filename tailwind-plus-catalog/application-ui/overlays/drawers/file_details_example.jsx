...
export default function OverlaysDrawersFileDetailsExample() {
                ...
                <div className="relative h-full overflow-y-auto bg-white p-8">
                  <div className="space-y-6 pb-16">
                    ...
                    <div className="flex">
                      ...
                      <button
                        type="button"
                        className="ml-3 flex-1 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs inset-ring inset-ring-gray-300 hover:bg-gray-50"
                      >
                        Delete
                      </button>
                    </div>
