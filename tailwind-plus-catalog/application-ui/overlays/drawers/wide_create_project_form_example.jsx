...
export default function OverlaysDrawersWideCreateProjectFormExample() {
                            ...
                            {team.map((person) => (
                              ...
                              >
                                <img
                                  alt={person.name}
                                  src={person.imageUrl}
                                  className="inline-block size-8 rounded-full bg-gray-100 outline -outline-offset-1 outline-black/5"
                                />
                              </a>
                            ))}
