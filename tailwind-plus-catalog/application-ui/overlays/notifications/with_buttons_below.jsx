...
export default function OverlaysNotificationsWithButtonsBelow() {
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 w-0 flex-1">
                    ...
                    <div className="mt-4 flex">
                      ...
                      <button
                        type="button"
                        className="ml-3 inline-flex items-center rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-xs inset-ring inset-ring-gray-300 hover:bg-gray-50"
                      >
                        Decline
                      </button>
                    </div>
