...
export default function FormsSelectMenusBrandedWithSupportedText() {
  ...
  return (
    <Listbox value={selected} onChange={setSelected}>
      ...
      <div className="relative">
        ...
        <ListboxOptions
          transition
          className="absolute right-0 z-10 mt-2 w-72 origin-top-right divide-y divide-gray-200 overflow-hidden rounded-md bg-white shadow-lg outline-1 outline-black/5 data-leave:transition data-leave:duration-100 data-leave:ease-in data-closed:data-leave:opacity-0"
        >
