...
export default function FormsComboboxesWithImage() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mt-2">
        ...
        <ComboboxOptions
          transition
          className="absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg outline outline-black/5 data-leave:transition data-leave:duration-100 data-leave:ease-in data-closed:data-leave:opacity-0 sm:text-sm"
        >
          {query.length > 0 && (
            <ComboboxOption
            ...
            >
              <div className="flex items-center">
                <div className="grid size-6 shrink-0 place-items-center rounded-full bg-gray-300 in-data-focus:bg-white">
                  <UserIcon className="size-4 fill-white in-data-focus:fill-indigo-600" aria-hidden="true" />
                </div>
            ...
            >
              <div className="flex items-center">
                <img
                  src={person.imageUrl}
                  alt=""
                  className="size-6 shrink-0 rounded-full bg-gray-100 outline -outline-offset-1 outline-black/5"
                />
