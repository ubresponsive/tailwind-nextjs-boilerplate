...
export default function FormsRadioGroupsStackedCards() {
  return (
      ...
      <div className="space-y-4">
        {plans.map((plan) => (
          <label
            ...
            className="group relative block rounded-lg border border-gray-300 bg-white px-6 py-4 has-checked:outline-2 has-checked:-outline-offset-2 has-checked:outline-indigo-600 has-focus-visible:outline-3 has-focus-visible:-outline-offset-1 sm:flex sm:justify-between"
          >
            <input
