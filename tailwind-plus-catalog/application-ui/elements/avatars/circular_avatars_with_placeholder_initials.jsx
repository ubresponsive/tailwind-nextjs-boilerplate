export default function ElementsAvatarsCircularAvatarsWithPlaceholderInitials() {
  return (
    <>
      <span className="inline-flex size-6 items-center justify-center rounded-full bg-gray-500 outline -outline-offset-1 outline-black/5">
      ...
      <span className="inline-flex size-12 items-center justify-center rounded-full bg-gray-500 outline -outline-offset-1 outline-black/5">
        <span className="text-lg font-medium text-white">TW</span>
      </span>

      <span className="inline-flex size-14 items-center justify-center rounded-full bg-gray-500 outline -outline-offset-1 outline-black/5">
