...
export default function ListsTablesWithHiddenHeadings() {
  return (
    <div>
                            ...
                            <div className="flex-auto">
                              <div className="flex items-start gap-x-3">
                                ...
                                {transaction.status === 'Withdraw' ? (
                                  <div className="rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 inset-ring inset-ring-gray-500/10">
                                    {transaction.status}
                                  </div>
                                ) : null}
                                {transaction.status === 'Overdue' ? (
                                  <div className="rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-700 inset-ring inset-ring-red-600/10">
                                    {transaction.status}
                                  </div>
                                ) : null}
                              </div>
