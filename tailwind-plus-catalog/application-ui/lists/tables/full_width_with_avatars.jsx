...
export default function ListsTablesFullWidthWithAvatars() {
  return (
            ...
            <tr key={item.commit}>
              <td className="py-4 pr-8 pl-4 sm:pl-6 lg:pl-8">
                <div className="flex items-center gap-x-4">
                  <img alt="" src={item.user.imageUrl} className="size-8 rounded-full bg-gray-100" />
              ...
              <td className="hidden py-4 pr-4 pl-0 sm:table-cell sm:pr-8">
                <div className="flex gap-x-3">
                  ...
                  <div className="rounded-md bg-gray-100 px-2 py-1 text-xs font-medium text-gray-600 outline-1 outline-gray-200">
                    {item.branch}
                  </div>
                </div>
              </td>
              ...
              <td className="hidden py-4 pr-8 pl-0 text-sm/6 text-gray-500 md:table-cell lg:pr-20">{item.duration}</td>
