...
export default function ListsFeedsWithComments() {
    ...
    <>
            ...
            {activityItem.type === 'commented' ? (
              <>
                <img
                  ...
                  className="relative mt-3 size-6 flex-none rounded-full bg-gray-50 outline -outline-offset-1 outline-black/5"
                />
      ...
      <div className="mt-6 flex gap-x-3">
        <img
          ...
          className="size-6 flex-none rounded-full bg-gray-50 outline -outline-offset-1 outline-black/5"
        />
