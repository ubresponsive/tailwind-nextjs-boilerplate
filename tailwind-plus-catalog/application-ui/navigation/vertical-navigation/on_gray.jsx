...
export default function NavigationVerticalNavigationOnGray() {
  return (
              ...
              <li key={item.name}>
                ...
                >
                  ...
                  {item.count ? (
                    <span
                      aria-hidden="true"
                      className="ml-auto w-9 min-w-max rounded-full bg-gray-50 px-2.5 py-0.5 text-center text-xs/5 font-medium whitespace-nowrap text-gray-600 outline-1 -outline-offset-1 outline-gray-200"
                    >
                      {item.count}
                    </span>
                  ) : null}
